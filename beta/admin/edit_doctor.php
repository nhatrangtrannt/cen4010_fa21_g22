...
<body>
<div class="container">
    <h1 class="my-5 text-center">Hello <?php $admin_username = $_SESSION['username']; echo "$admin_username!"; ?> This is where you edit doctor's information.</h1>
    ...
    <div class="row gutters">
        ...
        <div class="col-xl- col-lg-9 col-md-12 col-sm-12 col-12">
            <div class="card h-100">
                <div class="col-sm-12">
                    <!-- Patient list, Messages, Profile tab -->
