...
//    Trang Leminh: Great error checking mechanism done here in the event of invalid input
//    Maybe for phone number you can add another check to see if the phone number already exists in the database?
...
?>
<!--  Trang Leminh: Looks good structurally! Very clean code - maybe the style script can be a separate css file for even cleaner code? Looks great otherwise  -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
