...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // password,firstName,lastName,email,gender,birthday,phone,address,insuranceNum,diagnose,status
    // description,symptom,medication_bool,medication,allergy_bool,allergy
    ...
    // SELECT statement
                ...
                $sql = "INSERT INTO patient (username,password,firstName,lastName,email,gender,birthday,phone,address,insuranceNum,diagnose,status,description,symptom,medication_bool,medication,allergy_bool,allergy) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                ...
                if (!mysqli_stmt_prepare($stmt, $sql)) {
                    ...
                    // Bind variables
                    mysqli_stmt_bind_param($stmt, "ssssssssssssssssss", $username, $hashedpassword,$firstName,$lastName,$email,$gender,$birthday,$phone,$address,$insuranceNum,$diagnose,$status,$description,$symptom,$medication_bool,$medication,$allergy_bool,$allergy);
               ...
               /* $hashedpassword = password_hash($password, PASSWORD_DEFAULT);     
                ...
                $sql = "INSERT INTO patient (username,password,firstName,lastName,email,gender,birthday,phone,address,insuranceNum,diagnose,status,description,symptom,medication_bool,medication,allergy_bool,allergy) VALUES ('$username','$hashedpassword','$firstName','$lastName','$email','$gender','$birthday','$phone','$address','$insuranceNum','$diagnose','$status','$description','$symptom','$medication_bool','$medication','$allergy_bool','$allergy')";
                $stmt = mysqli_query($conn,$sql);
                if($stmt){
...
<!--Personal info-->    <h1 class="form-title">Medical Infomation</h1>
                        ...
                        <h3 class="form-title">Symptoms</h3>  
                        <div class="form-group">
                            <textarea class="form-input" name="symptom" placeholder="What Symptoms are you experiencing?" cols="63" rows="10" value="<?php if (isset($symptom)) echo $symptom;?>" required> </textarea>
                        </div>
